...
if(isset($_POST['name']) and isset($_FILES['pdf']['name']) and isset($_POST['hirer_id']) and  isset($_POST['code'])){
    echo "Inside Server";
    ...
    try{
        ...
        $result = mysqli_query($con,"SELECT * FROM HomeImages WHERE code ='$code' ");

        if( mysqli_num_rows($result) > 0) {
            mysqli_query($con,"UPDATE HomeImages SET url_contractor = '$file_url' WHERE code = '$code' ");
        }
        else{
            //saving the file
